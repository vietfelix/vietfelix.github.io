...
function countUpFromTime(countFrom) {
    ...
    setInterval(function() {
        ...
        var hours = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)).toLocaleString();
        var minutes = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60)).toLocaleString();
        var seconds = Math.floor((distance % (1000 * 60)) / 1000).toLocaleString();
